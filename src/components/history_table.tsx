...
import { getCommits } from "../lib/ipc_commands";
import type { Commit } from "../ts_rs_bindings/Commit";
import { computeGraphLayout, GraphRow } from "../lib/graph_layout";
import { getSettingsStore } from "../lib/store";
import { cn } from "../lib/utils";
import { HistoryTree } from "./history_tree";
import { debug } from "@tauri-apps/plugin-log";
import { useFontSize } from "./provider/font_size_provider";

export default function HistoryTable() {
    const { fontSize, rowHeight, colWidth, paddingLeft } = useFontSize();
    ...
    // 2. Compute Layout
    const data = useMemo(() => computeGraphLayout(commits), [commits]);
    ...
    const columns = useMemo<ColumnDef<GraphRow>[]>(
        ...
        [rowHeight, colWidth, paddingLeft, scale]
    );
